package edu.uci.ics.hcheng10.service.movies;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.hcheng10.service.movies.configs.ConfigsModel;
import edu.uci.ics.hcheng10.service.movies.configs.IdmConfigs;
import edu.uci.ics.hcheng10.service.movies.configs.ServiceConfigs;
...
public class MoviesService {
    ...
    public static final String RESOURCE_PATH = "edu.uci.ics.hcheng10.service.movies.resources";
        ...
        if (args.length > 0) {
            for (int i = 0; i < args.length; ++i) {
                switch (args[i]) {
                    ...
                    case "--default":
                    case "-d":
                        System.err.println("Default config options SELECT DISTINCTed.");
